...
BEGIN
   ...
   INSERT INTO
      $Database_Name.$Schema_Name.adwh_fact_profile_overlap_of_namespace_by_segment
      (date_key, merge_policy_id, overlap_id, segment_id, count_of_identities, count_of_profiles, count_of_Single_Identity_profiles$Dest_Columns)
        SELECT
              a.date_key,
              a.merge_policy_id,
              a.overlap_id,
